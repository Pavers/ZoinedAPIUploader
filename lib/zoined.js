...
const atvValidation = require('./validation/atvbudgets');
const uptValidation = require('./validation/uptbudgets');
...
exports.dataPost = async(postData, postType) => {
  ...
  case constants.ATVBUDGETS:
    return await atvValidation.validateATVBudgets(postData)
      .then(returnData => {
        return sendData(constants.ATVBUDGETS, returnData);
      }).catch(errorData => {
        return new Promise((resolve, reject) => {
          reject(errorData);
        });
  ...
  case constants.UPTBUDGETS:
    return await uptValidation.validateUPTBudgets(postData)
      .then(returnData => {
        return sendData(constants.UPTBUDGETS, returnData);
      }).catch(errorData => {
        return new Promise((resolve, reject) => {
          reject(errorData);
        });
  ...
  case constants.FEEDBACK:
    return await feedbackValidation.validateFeedback(postData)
      .then(returnData => {
        return sendData(constants.FEEDBACK, returnData);
      }).catch(errorData => {
        return new Promise((resolve, reject) => {
          reject(errorData);
        });
