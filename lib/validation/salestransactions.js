...
const validateSalesTransactions = async(data) => {
  ...
  let request = salesData.map((row) => {
    return new Promise((resolve, reject) => {
       ...
       * @param row.custom_field1 string
       * @param row.custom_field2 string
       * @param row.custom_field3 string
       * @param row.custom_field4 string
       * @param row.custom_field5 string
      ...
      if (row.custom_field1) {
        if (typeof row.custom_field1 !== 'string') {
          result.errorID = row.transaction_id;
          result.errorField = 'custom_field1';
          result.errorReason = 'Not a String';
          reject(result);
        }
      } else {
      ...
      if (row.custom_field2) {
        if (typeof row.custom_field2 !== 'string') {
          result.errorID = row.transaction_id;
          result.errorField = 'custom_field2';
          result.errorReason = 'Not a String';
          reject(result);
        }
      } else {
      ...
      if (row.custom_field3) {
        if (typeof row.custom_field3 !== 'string') {
          result.errorID = row.transaction_id;
          result.errorField = 'custom_field3';
          result.errorReason = 'Not a String';
          reject(result);
        }
      } else {
      ...
      if (row.custom_field4) {
        if (typeof row.custom_field4 !== 'string') {
          result.errorID = row.transaction_id;
          result.errorField = 'custom_field4';
          result.errorReason = 'Not a String';
          reject(result);
        }
      } else {
      ...
      if (row.custom_field5) {
        if (typeof row.custom_field5 !== 'string') {
          result.errorID = row.transaction_id;
          result.errorField = 'custom_field5';
          result.errorReason = 'Not a String';
          reject(result);
        }
      } else {
